...
/**
 * What gets stored for a job skipped by the job-type filter (jobFamilies.cjs):
 * not an assessment, just why it wasn't scored. The Resume popup still runs
 * a full assessment on it if asked.
 */
