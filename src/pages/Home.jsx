...
const FEATURES = [
  {
    ...
    description: "Automatically sync job listings from Greenhouse, AshbyHQ, Lever, Workable, SmartRecruiters, BambooHR, Workday & Oracle Cloud boards. Never miss a new posting again.",
