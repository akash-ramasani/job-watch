...
const FEATURES = [
  {
    ...
    desc: "Connect Greenhouse, AshbyHQ, Lever, Workable, SmartRecruiters, BambooHR, Workday, Oracle Cloud & Eightfold.ai job boards once. JobWatch syncs new postings automatically every 15 minutes.",
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            {[
              {
                ...
                desc: "Paste a Greenhouse, AshbyHQ, Lever, Workable, SmartRecruiters, BambooHR, Workday, Oracle Cloud or Eightfold.ai job board URL and we'll start watching it immediately.",
              },
              {
                step: "02",
